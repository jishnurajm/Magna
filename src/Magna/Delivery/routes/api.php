...
// Health probe — no auth required; used by load balancers and Octane smoke tests.
Route::get('/health', fn () => response()->json(['status' => 'ok']))->name('magna.delivery.health');
...
Route::middleware(['magna.api:management', DenyManagementCrossOriginMiddleware::class])->group(function (): void {
